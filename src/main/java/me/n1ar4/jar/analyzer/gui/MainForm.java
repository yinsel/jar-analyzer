...
public class MainForm {
    ...
    private void initializeComponents() {
        ...
        SwingLayout.add(masterPanel, rootSplit, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, new Dimension(200, 200), null, 0);
        ...
        SwingLayout.add(leftPanel, treeScrollPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(250, 800), new Dimension(250, 800), null, 0);
        ...
        SwingLayout.add(leftPanel, fileTreeSearchPanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, new Dimension(250, -1), new Dimension(250, -1), null, 0);
        searchFileNamePanel = new JPanel();
        SwingLayout.configureGrid(searchFileNamePanel, 2, 1, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(fileTreeSearchPanel, searchFileNamePanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, new Dimension(248, -1), new Dimension(248, -1), null, 0);
        ...
        SwingLayout.add(searchFileNamePanel, fileTreeSearchTextField, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, new Dimension(200, -1), new Dimension(200, -1), null, 0);
        fileTreeSearchLabel = new JLabel();
        fileTreeSearchLabel.setText("");
        fileTreeSearchLabel.setVisible(false);
        SwingLayout.add(searchFileNamePanel, fileTreeSearchLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, new Dimension(246, -1), new Dimension(246, -1), null, 0);
        ...
        SwingLayout.add(coreRightSplit, tabbedPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(startPanel, chosePanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(chosePanel, choseBtn, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        fileText = new JTextField();
        fileText.setEditable(false);
        fileText.setText("");
        SwingLayout.add(chosePanel, fileText, 0, 1, 1, 6, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        resolveJarsInJarCheckBox = new JCheckBox();
        resolveJarsInJarCheckBox.setText("Resolve Jars in Jar");
        SwingLayout.add(chosePanel, resolveJarsInJarCheckBox, 5, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        buildBar = new JProgressBar();
        buildBar.setForeground(new Color(-9524737));
        buildBar.setStringPainted(true);
        SwingLayout.add(chosePanel, buildBar, 7, 0, 1, 7, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        autoSaveCheckBox = new JCheckBox();
        autoSaveCheckBox.setText("Auto Save");
        SwingLayout.add(chosePanel, autoSaveCheckBox, 5, 1, 1, 4, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        dbPathLabel = new JLabel();
        dbPathLabel.setText("Database Path");
        SwingLayout.add(chosePanel, dbPathLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        loadDBText = new JTextField();
        loadDBText.setEditable(false);
        SwingLayout.add(chosePanel, loadDBText, 1, 1, 1, 6, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        jreRuntimeLabel = new JLabel();
        jreRuntimeLabel.setText("JRE Runtime");
        SwingLayout.add(chosePanel, jreRuntimeLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        rtText = new JTextField();
        rtText.setEditable(false);
        SwingLayout.add(chosePanel, rtText, 2, 1, 1, 6, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        autoFindRtJarCheckBox = new JCheckBox();
        autoFindRtJarCheckBox.setText("Auto Find rt.jar");
        SwingLayout.add(chosePanel, autoFindRtJarCheckBox, 6, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        addRtJarWhenCheckBox = new JCheckBox();
        addRtJarWhenCheckBox.setText("Add rt.jar to Analyze");
        SwingLayout.add(chosePanel, addRtJarWhenCheckBox, 6, 1, 1, 4, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        classBlackListLabel = new JLabel();
        classBlackListLabel.setText("Class Black List");
        SwingLayout.add(chosePanel, classBlackListLabel, 4, 0, 1, 1, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        classBlackPanel = new JScrollPane();
        SwingLayout.add(chosePanel, classBlackPanel, 4, 1, 1, 6, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(-1, 75), new Dimension(-1, 75), new Dimension(-1, 75), 0);
        ...
        SwingLayout.add(chosePanel, classWhiteListLabel, 3, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        classWhitePanel = new JScrollPane();
        SwingLayout.add(chosePanel, classWhitePanel, 3, 1, 1, 6, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(-1, 75), new Dimension(-1, 75), new Dimension(-1, 75), 0);
        ...
        SwingLayout.add(chosePanel, decompilerPanel, 8, 0, 1, 7, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(decompilerPanel, fernRadio, 1, 0, 1, 2, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        opcodeBtn = new JButton();
        opcodeBtn.setText("Show Method Opcode");
        SwingLayout.add(decompilerPanel, opcodeBtn, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        javaAsmBtn = new JButton();
        javaAsmBtn.setText("Java ASM Code");
        SwingLayout.add(decompilerPanel, javaAsmBtn, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        enginePanel = new JPanel();
        SwingLayout.configureGrid(enginePanel, 1, 2, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(chosePanel, enginePanel, 6, 5, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        startEngineButton = new JButton();
        startEngineButton.setText("Start");
        SwingLayout.add(enginePanel, startEngineButton, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        openJDBtn = new JButton();
        openJDBtn.setText("JD-GUI");
        SwingLayout.add(enginePanel, openJDBtn, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        ...
        SwingLayout.add(infoPanel, totalClassLabel, 3, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        totalClassVal = new JLabel();
        totalClassVal.setText("0");
        SwingLayout.add(infoPanel, totalClassVal, 3, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        totalMethodLabel = new JLabel();
        totalMethodLabel.setText("Total Method");
        SwingLayout.add(infoPanel, totalMethodLabel, 4, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        totalMethodVal = new JLabel();
        totalMethodVal.setText("0");
        SwingLayout.add(infoPanel, totalMethodVal, 4, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        totalJarLabel = new JLabel();
        totalJarLabel.setText("Total Jar");
        SwingLayout.add(infoPanel, totalJarLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        totalJarVal = new JLabel();
        totalJarVal.setText("0");
        SwingLayout.add(infoPanel, totalJarVal, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        databaseSizeLabel = new JLabel();
        databaseSizeLabel.setText("Database");
        SwingLayout.add(infoPanel, databaseSizeLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        databaseSizeVal = new JLabel();
        databaseSizeVal.setText("0 MB");
        SwingLayout.add(infoPanel, databaseSizeVal, 1, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        engineLabel = new JLabel();
        engineLabel.setText("Engine State");
        SwingLayout.add(infoPanel, engineLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        engineVal = new JLabel();
        engineVal.setText("CLOSED");
        SwingLayout.add(infoPanel, engineVal, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        authorPanel = new JPanel();
        SwingLayout.configureGrid(authorPanel, 2, 1, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(infoPanel, authorPanel, 0, 2, 5, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, new Dimension(100, -1), new Dimension(100, -1), new Dimension(100, -1), 0);
        authorLabel = new JLabel();
        authorLabel.setText("");
        SwingLayout.add(authorPanel, authorLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        authorTextLabel = new JLabel();
        authorTextLabel.setText("4ra1n");
        SwingLayout.add(authorPanel, authorTextLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        actionPanel = new JPanel();
        SwingLayout.configureGrid(actionPanel, 1, 4, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(startPanel, actionPanel, 2, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(actionPanel, cleanButton, 0, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        showStringListButton = new JButton();
        showStringListButton.setText("All Strings");
        SwingLayout.add(actionPanel, showStringListButton, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        startELSearchButton = new JButton();
        startELSearchButton.setText("EL Search");
        SwingLayout.add(actionPanel, startELSearchButton, 0, 3, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        quickSinkBtn = new JButton();
        quickSinkBtn.setText("一键搜 Sink");
        SwingLayout.add(actionPanel, quickSinkBtn, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        ...
        SwingLayout.add(searchResPanel, searchScroll, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(searchResPanel, searchOptionsPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(searchOptionsPanel, methodDefinitionRadioButton, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        methodCallRadioButton = new JRadioButton();
        methodCallRadioButton.setText("method call (方法调用)");
        SwingLayout.add(searchOptionsPanel, methodCallRadioButton, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        stringContainsRadioButton = new JRadioButton();
        stringContainsRadioButton.setText("string contains (包含字符串)");
        SwingLayout.add(searchOptionsPanel, stringContainsRadioButton, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        binarySearchRadioButton = new JRadioButton();
        binarySearchRadioButton.setText("binary search (二进制包含)");
        SwingLayout.add(searchOptionsPanel, binarySearchRadioButton, 1, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        searchInnerPanel = new JPanel();
        SwingLayout.configureGrid(searchInnerPanel, 3, 3, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(searchOptionsPanel, searchInnerPanel, 3, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        searchClassText = new JTextField();
        SwingLayout.add(searchInnerPanel, searchClassText, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        searchClassLabel = new JLabel();
        searchClassLabel.setText("Class");
        SwingLayout.add(searchInnerPanel, searchClassLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        searchMethodLabel = new JLabel();
        searchMethodLabel.setText("Method");
        SwingLayout.add(searchInnerPanel, searchMethodLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        searchMethodText = new JTextField();
        SwingLayout.add(searchInnerPanel, searchMethodText, 1, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        searchStrLabel = new JLabel();
        searchStrLabel.setText("String");
        SwingLayout.add(searchInnerPanel, searchStrLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        searchStrText = new JTextField();
        SwingLayout.add(searchInnerPanel, searchStrText, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        startSearchButton = new JButton();
        startSearchButton.setText("Start Search");
        SwingLayout.add(searchInnerPanel, startSearchButton, 2, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        ...
        SwingLayout.add(searchInnerPanel, exportSearchJsonBtn, 1, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(72, -1), null, 0);
        logoLabel = new JLabel();
        logoLabel.setText("");
        SwingLayout.add(searchInnerPanel, logoLabel, 0, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        soPanel = new JPanel();
        SwingLayout.configureGrid(soPanel, 3, 2, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(searchOptionsPanel, soPanel, 2, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(soPanel, likeSearchRadioButton, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        equalsSearchRadioButton = new JRadioButton();
        equalsSearchRadioButton.setText("equals search (精确搜索模式)");
        SwingLayout.add(soPanel, equalsSearchRadioButton, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        blackListPanel = new JPanel();
        SwingLayout.configureGrid(blackListPanel, 3, 2, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(soPanel, blackListPanel, 2, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        blackScroll = new JScrollPane();
        SwingLayout.add(blackListPanel, blackScroll, 2, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(-1, 100), new Dimension(-1, 100), new Dimension(-1, 100), 0);
        ...
        SwingLayout.add(blackListPanel, classBlackLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        filterModeCombo = new JComboBox();
        SwingLayout.add(blackListPanel, filterModeCombo, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        npbPanel = new JPanel();
        SwingLayout.configureGrid(npbPanel, 1, 1, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(soPanel, npbPanel, 1, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        nullParamBox = new JCheckBox();
        nullParamBox.setText("except null parameter method / 排除空参方法 (空参方法一般无漏洞)");
        SwingLayout.add(npbPanel, nullParamBox, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        ...
        SwingLayout.add(callPanel, callerScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(callPanel, calleeScroll, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(methodImplPanel, implScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(methodImplPanel, superImplScroll, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(webPanel, webTabbed, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, new Dimension(200, 200), null, 0);
        ...
        SwingLayout.add(springPanel, springCPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        scScroll = new JScrollPane();
        SwingLayout.add(springCPanel, scScroll, 3, 0, 1, 3, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        springCList = new JList();
        scScroll.setViewportView(springCList);
        refreshButton = new JButton();
        refreshButton.setText("Refresh All");
        SwingLayout.add(springCPanel, refreshButton, 1, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        springLabel = new JLabel();
        springLabel.setText(" Analyze Spring Controllers and Mappings in Jar/Jars");
        SwingLayout.add(springCPanel, springLabel, 1, 0, 1, 2, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        pathSearchButton = new JButton();
        pathSearchButton.setText("Search");
        SwingLayout.add(springCPanel, pathSearchButton, 2, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        pathSearchLabel = new JLabel();
        pathSearchLabel.setText(" Search path in all Mappings");
        SwingLayout.add(springCPanel, pathSearchLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        pathSearchTextField = new JTextField();
        pathSearchTextField.setToolTipText("");
        SwingLayout.add(springCPanel, pathSearchTextField, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        exportPanel = new JPanel();
        SwingLayout.configureGrid(exportPanel, 1, 5, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(springCPanel, exportPanel, 0, 0, 1, 3, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        exportJsonBtn = new JButton();
        exportJsonBtn.setText("导出为 JSON");
        SwingLayout.add(exportPanel, exportJsonBtn, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        final Component spacer1 = SwingLayout.spacer();
        SwingLayout.add(exportPanel, spacer1, 0, 4, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK, null, null, null, 0);
        exportTxtBtn = new JButton();
        exportTxtBtn.setText("导出为 TXT");
        SwingLayout.add(exportPanel, exportTxtBtn, 0, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        exportCsvBtn = new JButton();
        exportCsvBtn.setText("导出为 CSV");
        SwingLayout.add(exportPanel, exportCsvBtn, 0, 3, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        exportAllLabel = new JLabel();
        exportAllLabel.setText(" Export All Data / 导出所有结果");
        SwingLayout.add(exportPanel, exportAllLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        springMPanel = new JPanel();
        SwingLayout.configureGrid(springMPanel, 1, 1, new Insets(0, 0, 0, 3), -1, -1);
        SwingLayout.add(springPanel, springMPanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        smScroll = new JScrollPane();
        SwingLayout.add(springMPanel, smScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(springIPanel, springIScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(springConfigPanel, springConfigScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(servletPanel, servletScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(filterPanel, filterScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(listenerPanel, listenerScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(notePanel, hisScroll, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(notePanel, favScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(notePanel, favHisPanel, 2, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        loadFavBtn = new JButton();
        loadFavBtn.setText("加载历史 favorites/history");
        SwingLayout.add(favHisPanel, loadFavBtn, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        final Component spacer2 = SwingLayout.spacer();
        SwingLayout.add(favHisPanel, spacer2, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK, null, null, null, 0);
        scaPanel = new JPanel();
        ...
        SwingLayout.add(scaPanel, modulePanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(modulePanel, scaLog4jBox, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        scaShiroBox = new JCheckBox();
        scaShiroBox.setText("Apache Shiro");
        SwingLayout.add(modulePanel, scaShiroBox, 1, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        scaTipPanel = new JPanel();
        SwingLayout.configureGrid(scaTipPanel, 1, 1, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(modulePanel, scaTipPanel, 0, 0, 1, 3, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        scaTipLabel = new JLabel();
        scaTipLabel.setText(" not recommended to enable multiple modules in one analysis");
        SwingLayout.add(scaTipPanel, scaTipLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        scaFastjsonBox = new JCheckBox();
        scaFastjsonBox.setText("FASTJSON");
        SwingLayout.add(modulePanel, scaFastjsonBox, 1, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        final Component spacer3 = SwingLayout.spacer();
        SwingLayout.add(scaPanel, spacer3, 2, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, SwingLayout.SIZEPOLICY_CAN_SHRINK, SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        scaActionPanel = new JPanel();
        SwingLayout.configureGrid(scaActionPanel, 4, 3, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(scaPanel, scaActionPanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(scaActionPanel, scaFileLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        scaFileText = new JTextField();
        SwingLayout.add(scaActionPanel, scaFileText, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        scaOpenBtn = new JButton();
        scaOpenBtn.setText("OPEN");
        SwingLayout.add(scaActionPanel, scaOpenBtn, 0, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        scanConsoleScroll = new JScrollPane();
        SwingLayout.add(scaActionPanel, scanConsoleScroll, 3, 0, 1, 3, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(scaActionPanel, scaOutLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        scaOutPanel = new JPanel();
        SwingLayout.configureGrid(scaOutPanel, 1, 2, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(scaActionPanel, scaOutPanel, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        scaOutConsoleRadio = new JRadioButton();
        scaOutConsoleRadio.setText("CONSOLE");
        SwingLayout.add(scaOutPanel, scaOutConsoleRadio, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        scaOutHtmlRadio = new JRadioButton();
        scaOutHtmlRadio.setText("HTML");
        SwingLayout.add(scaOutPanel, scaOutHtmlRadio, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        scaStartBtn = new JButton();
        scaStartBtn.setText("START");
        SwingLayout.add(scaActionPanel, scaStartBtn, 1, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        outputFileLabel = new JLabel();
        outputFileLabel.setText("OUTPUT FILE");
        SwingLayout.add(scaActionPanel, outputFileLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        outputFileText = new JTextField();
        SwingLayout.add(scaActionPanel, outputFileText, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        scaResultOpenBtn = new JButton();
        scaResultOpenBtn.setText("OPEN");
        SwingLayout.add(scaActionPanel, scaResultOpenBtn, 2, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        ...
        SwingLayout.add(leakPanel, leakRulesPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(leakRulesPanel, leakUrlBox, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakJdbcBox = new JCheckBox();
        leakJdbcBox.setText("JDBC Connection");
        SwingLayout.add(leakRulesPanel, leakJdbcBox, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakFileBox = new JCheckBox();
        leakFileBox.setText("File Path");
        SwingLayout.add(leakRulesPanel, leakFileBox, 0, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakJWTBox = new JCheckBox();
        leakJWTBox.setText("JWT");
        SwingLayout.add(leakRulesPanel, leakJWTBox, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakMacBox = new JCheckBox();
        leakMacBox.setText("MAC Address");
        SwingLayout.add(leakRulesPanel, leakMacBox, 1, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakIpBox = new JCheckBox();
        leakIpBox.setText("IP Address");
        SwingLayout.add(leakRulesPanel, leakIpBox, 1, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakPhoneBox = new JCheckBox();
        leakPhoneBox.setText("Phone Number");
        SwingLayout.add(leakRulesPanel, leakPhoneBox, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakIdBox = new JCheckBox();
        leakIdBox.setText("ID Card");
        SwingLayout.add(leakRulesPanel, leakIdBox, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakEmailBox = new JCheckBox();
        leakEmailBox.setText("Email");
        SwingLayout.add(leakRulesPanel, leakEmailBox, 2, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        AKSKCheckBox = new JCheckBox();
        AKSKCheckBox.setText("AK SK");
        SwingLayout.add(leakRulesPanel, AKSKCheckBox, 3, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        bankCardCheckBox = new JCheckBox();
        bankCardCheckBox.setText("Bank Card");
        SwingLayout.add(leakRulesPanel, bankCardCheckBox, 3, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        APIKeyCheckBox = new JCheckBox();
        APIKeyCheckBox.setText("API Key");
        SwingLayout.add(leakRulesPanel, APIKeyCheckBox, 3, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        cryptoKeyCheckBox = new JCheckBox();
        cryptoKeyCheckBox.setText("Crypto Key");
        SwingLayout.add(leakRulesPanel, cryptoKeyCheckBox, 4, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        AIKeyCheckBox = new JCheckBox();
        AIKeyCheckBox.setText("AI Key");
        SwingLayout.add(leakRulesPanel, AIKeyCheckBox, 4, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        passwordCheckBox = new JCheckBox();
        passwordCheckBox.setText("Password");
        SwingLayout.add(leakRulesPanel, passwordCheckBox, 4, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakConfigPanel = new JPanel();
        SwingLayout.configureGrid(leakConfigPanel, 1, 6, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(leakPanel, leakConfigPanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(leakConfigPanel, leakDetBase64Box, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakAITriageBox = new JCheckBox();
        leakAITriageBox.setText("AI Triage");
        leakAITriageBox.setToolTipText("启用 AI 对每条命中结果研判，仅展示通过的结果");
        SwingLayout.add(leakConfigPanel, leakAITriageBox, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        ...
        SwingLayout.add(leakConfigPanel, leakAITriageViewBtn, 0, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakStartBtn = new JButton();
        leakStartBtn.setText("START");
        SwingLayout.add(leakConfigPanel, leakStartBtn, 0, 3, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakCleanBtn = new JButton();
        leakCleanBtn.setText("CLEAN");
        SwingLayout.add(leakConfigPanel, leakCleanBtn, 0, 4, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        exportLeakBtn = new JButton();
        exportLeakBtn.setText("EXPORT");
        SwingLayout.add(leakConfigPanel, exportLeakBtn, 0, 5, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        ...
        SwingLayout.add(leakPanel, leakProgressBar, 2, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        leakResultPanel = new JPanel();
        SwingLayout.configureGrid(leakResultPanel, 1, 1, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(leakPanel, leakResultPanel, 3, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(leakResultPanel, leakResultScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(-1, 300), null, null, 0);
        ...
        SwingLayout.add(gadgetPanel, gadgetInputPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetDirLabel = new JLabel();
        gadgetDirLabel.setText("选择依赖目录");
        SwingLayout.add(gadgetInputPanel, gadgetDirLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetChoseBtn = new JButton();
        gadgetChoseBtn.setText("选择");
        SwingLayout.add(gadgetInputPanel, gadgetChoseBtn, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetInputText = new JTextField();
        gadgetInputText.setEditable(false);
        SwingLayout.add(gadgetInputPanel, gadgetInputText, 0, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        gadgetDescLabel = new JLabel();
        gadgetDescLabel.setText("说明");
        SwingLayout.add(gadgetInputPanel, gadgetDescLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetDescValueLabel = new JLabel();
        gadgetDescValueLabel.setText("");
        SwingLayout.add(gadgetInputPanel, gadgetDescValueLabel, 1, 1, 1, 2, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetOpPanel = new JPanel();
        SwingLayout.configureGrid(gadgetOpPanel, 1, 5, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(gadgetInputPanel, gadgetOpPanel, 2, 0, 1, 3, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        gadgetStartBtn = new JButton();
        gadgetStartBtn.setText("开始分析");
        SwingLayout.add(gadgetOpPanel, gadgetStartBtn, 0, 4, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetNativeBox = new JCheckBox();
        gadgetNativeBox.setText("原生");
        SwingLayout.add(gadgetOpPanel, gadgetNativeBox, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetHessianBox = new JCheckBox();
        gadgetHessianBox.setText("Hessian");
        SwingLayout.add(gadgetOpPanel, gadgetHessianBox, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetJdbcBox = new JCheckBox();
        gadgetJdbcBox.setText("JDBC");
        SwingLayout.add(gadgetOpPanel, gadgetJdbcBox, 0, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetFastjsonBox = new JCheckBox();
        gadgetFastjsonBox.setText("Fastjson");
        SwingLayout.add(gadgetOpPanel, gadgetFastjsonBox, 0, 3, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        gadgetResultPanel = new JPanel();
        SwingLayout.configureGrid(gadgetResultPanel, 1, 1, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(gadgetPanel, gadgetResultPanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        gadgetResultScroll = new JScrollPane();
        SwingLayout.add(gadgetResultPanel, gadgetResultScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(advancePanel, javaVulSearchPanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(javaVulSearchPanel, javaVulLabel, 0, 0, 1, 3, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        javaVulScroll = new JScrollPane();
        SwingLayout.add(javaVulSearchPanel, javaVulScroll, 2, 0, 10, 3, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        vulOpPanel = new JPanel();
        SwingLayout.configureGrid(vulOpPanel, 1, 5, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(javaVulSearchPanel, vulOpPanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        showLowRadio = new JRadioButton();
        showLowRadio.setText("展示低危（low）");
        SwingLayout.add(vulOpPanel, showLowRadio, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        final Component spacer4 = SwingLayout.spacer();
        SwingLayout.add(vulOpPanel, spacer4, 0, 4, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK, null, null, null, 0);
        showMediumRadio = new JRadioButton();
        showMediumRadio.setText("展示中危（medium）");
        SwingLayout.add(vulOpPanel, showMediumRadio, 0, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        showHighRadio = new JRadioButton();
        showHighRadio.setText("展示高危（high）");
        SwingLayout.add(vulOpPanel, showHighRadio, 0, 3, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        showAllRadio = new JRadioButton();
        showAllRadio.setText("全部");
        SwingLayout.add(vulOpPanel, showAllRadio, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        final Component spacer5 = SwingLayout.spacer();
        SwingLayout.add(advancePanel, spacer5, 3, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, SwingLayout.SIZEPOLICY_CAN_SHRINK, SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        piPanel = new JPanel();
        SwingLayout.configureGrid(piPanel, 6, 2, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(advancePanel, piPanel, 2, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(piPanel, encoderLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        encoderBtn = new JButton();
        encoderBtn.setText("Start");
        SwingLayout.add(piPanel, encoderBtn, 2, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        listenerLabel = new JLabel();
        listenerLabel.setText("A tool for listening port and send by socket");
        SwingLayout.add(piPanel, listenerLabel, 3, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        listenerBtn = new JButton();
        listenerBtn.setText("Start");
        SwingLayout.add(piPanel, listenerBtn, 3, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sqliteButton = new JButton();
        sqliteButton.setText("Start");
        SwingLayout.add(piPanel, sqliteButton, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sqliteLabel = new JLabel();
        sqliteLabel.setText("A tool for run custom query in SQLite database");
        SwingLayout.add(piPanel, sqliteLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        spelLabel = new JLabel();
        spelLabel.setText("A tool for Spring EL search");
        SwingLayout.add(piPanel, spelLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        springELStartButton = new JButton();
        springELStartButton.setText("Start");
        SwingLayout.add(piPanel, springELStartButton, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        serUtilLabel = new JLabel();
        serUtilLabel.setText("A tool for bytecodes in Java Serialization Data");
        SwingLayout.add(piPanel, serUtilLabel, 4, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        serUtilBtn = new JButton();
        serUtilBtn.setText("Start");
        SwingLayout.add(piPanel, serUtilBtn, 4, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        bcelLabel = new JLabel();
        bcelLabel.setText("A tool for parse BCEL bytecode to Java code");
        SwingLayout.add(piPanel, bcelLabel, 5, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        bcelBtn = new JButton();
        bcelBtn.setText("Start");
        SwingLayout.add(piPanel, bcelBtn, 5, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        analysis = new JPanel();
        SwingLayout.configureGrid(analysis, 1, 10, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(advancePanel, analysis, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(analysis, frameBtn, 0, 7, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, new Dimension(150, -1), 0);
        cfgBtn = new JButton();
        cfgBtn.setText("Show CFG");
        SwingLayout.add(analysis, cfgBtn, 0, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, new Dimension(150, -1), 0);
        simpleFrameButton = new JButton();
        simpleFrameButton.setText("Simple Frame");
        SwingLayout.add(analysis, simpleFrameButton, 0, 5, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, new Dimension(150, -1), 0);
        htmlGraphBtn = new JButton();
        htmlGraphBtn.setText("HTML Graph");
        SwingLayout.add(analysis, htmlGraphBtn, 0, 2, 1, 3, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, new Dimension(150, -1), 0);
        ...
        SwingLayout.add(chainsPanel, chainsSinkPanel, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(chainsSinkPanel, sinkClassLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sinkClassText = new JTextField();
        SwingLayout.add(chainsSinkPanel, sinkClassText, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        sinkMethodLabel = new JLabel();
        sinkMethodLabel.setText("Sink Method");
        SwingLayout.add(chainsSinkPanel, sinkMethodLabel, 3, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sinkDescLabel = new JLabel();
        sinkDescLabel.setText("Sink Desc");
        SwingLayout.add(chainsSinkPanel, sinkDescLabel, 4, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sinkMethodText = new JTextField();
        SwingLayout.add(chainsSinkPanel, sinkMethodText, 3, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        sinkDescText = new JTextField();
        SwingLayout.add(chainsSinkPanel, sinkDescText, 4, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        sinkTipLabel = new JLabel();
        sinkTipLabel.setText("从 note -> favorites 右键 send to sink");
        SwingLayout.add(chainsSinkPanel, sinkTipLabel, 0, 0, 1, 2, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sinkBox = new JComboBox();
        SwingLayout.add(chainsSinkPanel, sinkBox, 1, 0, 1, 2, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sinkJarLabel = new JLabel();
        sinkJarLabel.setText("注意：不要求加载 Jar 中包含 Sink 类");
        SwingLayout.add(chainsSinkPanel, sinkJarLabel, 5, 0, 1, 2, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        chainsSourcePanel = new JPanel();
        SwingLayout.configureGrid(chainsSourcePanel, 5, 2, new Insets(5, 5, 5, 5), -1, -1);
        SwingLayout.add(chainsPanel, chainsSourcePanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(chainsSourcePanel, sourceClassLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sourceClassText = new JTextField();
        SwingLayout.add(chainsSourcePanel, sourceClassText, 1, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        sourceMethodLabel = new JLabel();
        sourceMethodLabel.setText("Source Method");
        SwingLayout.add(chainsSourcePanel, sourceMethodLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sourceDescLabel = new JLabel();
        sourceDescLabel.setText("Source Desc");
        SwingLayout.add(chainsSourcePanel, sourceDescLabel, 3, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sourceMethodText = new JTextField();
        SwingLayout.add(chainsSourcePanel, sourceMethodText, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        sourceDescText = new JTextField();
        SwingLayout.add(chainsSourcePanel, sourceDescText, 3, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        sourceTipLabel = new JLabel();
        sourceTipLabel.setText("从 note -> favorites 右键 send to source");
        SwingLayout.add(chainsSourcePanel, sourceTipLabel, 0, 0, 1, 2, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sourcePanel = new JPanel();
        SwingLayout.configureGrid(sourcePanel, 2, 3, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(chainsSourcePanel, sourcePanel, 4, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        sourceNullRadio = new JRadioButton();
        sourceNullRadio.setText("空 Source 列举");
        SwingLayout.add(sourcePanel, sourceNullRadio, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sourceEnableRadio = new JRadioButton();
        sourceEnableRadio.setText("指定 Source 搜索");
        SwingLayout.add(sourcePanel, sourceEnableRadio, 0, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sourceLabel = new JLabel();
        sourceLabel.setText("模式");
        SwingLayout.add(sourcePanel, sourceLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sourceOnlyWebBox = new JCheckBox();
        sourceOnlyWebBox.setText("Source 只考虑 Spring / Servlet 入口");
        SwingLayout.add(sourcePanel, sourceOnlyWebBox, 1, 1, 1, 2, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        chainsDescPanel = new JPanel();
        SwingLayout.configureGrid(chainsDescPanel, 1, 2, new Insets(5, 5, 5, 5), -1, -1);
        SwingLayout.add(chainsPanel, chainsDescPanel, 0, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        chainsLabel = new JLabel();
        chainsLabel.setText("");
        SwingLayout.add(chainsDescPanel, chainsLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        final Component spacer6 = SwingLayout.spacer();
        SwingLayout.add(chainsDescPanel, spacer6, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK, null, null, null, 0);
        chainsOpPanel = new JPanel();
        SwingLayout.configureGrid(chainsOpPanel, 2, 8, new Insets(5, 5, 5, 5), -1, -1);
        SwingLayout.add(chainsPanel, chainsOpPanel, 3, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(chainsOpPanel, startChainsBtn, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sourceRadio = new JRadioButton();
        sourceRadio.setText("从 Source 分析");
        SwingLayout.add(chainsOpPanel, sourceRadio, 0, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        sinkRadio = new JRadioButton();
        sinkRadio.setText("从 Sink 分析");
        SwingLayout.add(chainsOpPanel, sinkRadio, 0, 3, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        maxDepthSpin = new JSpinner();
        SwingLayout.add(chainsOpPanel, maxDepthSpin, 0, 5, 1, 2, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, new Dimension(80, -1), 0);
        maxDepthLabel = new JLabel();
        maxDepthLabel.setText("最大深度");
        SwingLayout.add(chainsOpPanel, maxDepthLabel, 0, 4, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        final Component spacer7 = SwingLayout.spacer();
        SwingLayout.add(chainsOpPanel, spacer7, 0, 7, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK, null, null, null, 0);
        clearBtn = new JButton();
        clearBtn.setText("清空");
        SwingLayout.add(chainsOpPanel, clearBtn, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        taintBox = new JCheckBox();
        taintBox.setText("污点分析验证");
        SwingLayout.add(chainsOpPanel, taintBox, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        startTaintBtn = new JButton();
        startTaintBtn.setText("手动启动污点分析");
        SwingLayout.add(chainsOpPanel, startTaintBtn, 1, 4, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        dfsAdvanceBtn = new JButton();
        dfsAdvanceBtn.setText("高级设置（数量限制/导出等）");
        SwingLayout.add(chainsOpPanel, dfsAdvanceBtn, 1, 1, 1, 3, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        SwingLayout.add(chainsPanel, chainsResult, 2, 0, 1, 2, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        curPanel = new JPanel();
        SwingLayout.configureGrid(curPanel, 3, 3, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(coreRightSplit, curPanel, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(curPanel, curClassLabel, 1, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        curClassText = new JTextField();
        curClassText.setEditable(false);
        SwingLayout.add(curPanel, curClassText, 1, 1, 1, 2, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        curMethodLabel = new JLabel();
        curMethodLabel.setText("Method");
        SwingLayout.add(curPanel, curMethodLabel, 2, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        curMethodText = new JTextField();
        curMethodText.setEditable(false);
        SwingLayout.add(curPanel, curMethodText, 2, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        curJarLabel = new JLabel();
        curJarLabel.setText("Jar");
        SwingLayout.add(curPanel, curJarLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 1);
        curJarText = new JTextField();
        curJarText.setEditable(false);
        SwingLayout.add(curPanel, curJarText, 0, 1, 1, 2, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0);
        addToFavoritesButton = new JButton();
        addToFavoritesButton.setText("add to favorites");
        SwingLayout.add(curPanel, addToFavoritesButton, 2, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        final Component spacer8 = SwingLayout.spacer();
        SwingLayout.add(coreRightSplit, spacer8, 2, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, SwingLayout.SIZEPOLICY_CAN_SHRINK, SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        logPanel = new JPanel();
        SwingLayout.configureGrid(logPanel, 1, 2, new Insets(0, 0, 0, 0), -1, -1);
        treeContentSplit.setRightComponent(logPanel);
        logScroll = new JScrollPane();
        SwingLayout.add(logPanel, logScroll, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(500, 100), new Dimension(500, 100), null, 0);
        ...
        SwingLayout.add(logPanel, curMethodPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, new Dimension(600, 150), new Dimension(600, 150), null, 0);
        allMethodScroll = new JScrollPane();
        SwingLayout.add(curMethodPanel, allMethodScroll, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
