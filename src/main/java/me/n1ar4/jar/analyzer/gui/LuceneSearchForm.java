...
public class LuceneSearchForm {
    ...
    private void initializeComponents() {
        ...
        SwingLayout.add(rootPanel, searchInputPanel, 0, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        searchIconLabel = new JLabel();
        searchIconLabel.setText("");
        SwingLayout.add(searchInputPanel, searchIconLabel, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_FIXED, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        searchOptionPanel = new JPanel();
        SwingLayout.configureGrid(searchOptionPanel, 1, 2, new Insets(0, 0, 0, 0), -1, -1);
        SwingLayout.add(searchInputPanel, searchOptionPanel, 0, 2, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        containsRadio = new JRadioButton();
        containsRadio.setText("contains");
        SwingLayout.add(searchOptionPanel, containsRadio, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        regexRadio = new JRadioButton();
        regexRadio.setText("regexp");
        SwingLayout.add(searchOptionPanel, regexRadio, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        searchOptionsPanel = new JPanel();
        SwingLayout.configureGrid(searchOptionsPanel, 2, 3, new Insets(3, 3, 3, 3), -1, -1);
        SwingLayout.add(searchInputPanel, searchOptionsPanel, 1, 0, 1, 3, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, null, null, null, 0);
        ...
        SwingLayout.add(searchOptionsPanel, noLuceneRadio, 0, 0, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        paLuceneRadio = new JRadioButton();
        paLuceneRadio.setText("被动构建 Lucene 索引 (每次反编译代码自动提交)");
        SwingLayout.add(searchOptionsPanel, paLuceneRadio, 0, 1, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        ...
        SwingLayout.add(searchOptionsPanel, caseCheckBox, 0, 2, 1, 1, GridBagConstraints.WEST, GridBagConstraints.NONE, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_CAN_GROW, SwingLayout.SIZEPOLICY_FIXED, null, null, null, 0);
        searchTextPanel = new JScrollPane();
        SwingLayout.add(searchInputPanel, searchTextPanel, 0, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, null, null, null, 0);
        ...
        SwingLayout.add(rootPanel, searchScroll, 1, 0, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.BOTH, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, SwingLayout.SIZEPOLICY_CAN_SHRINK | SwingLayout.SIZEPOLICY_WANT_GROW, new Dimension(650, 400), new Dimension(650, 400), new Dimension(650, 400), 0);
